...
class Restart_Level_Screen(s.Screen):
    pygame.init()
    restart_scrn = pygame.display.set_mode((1200,700))
    #pygame.display.set_caption(s.Screen.title)
...
class Button(Welcome_Screen, GameOver_Screen):
    ...
    def draw_btn_restart(self):
        Restart_Level_Screen.restart_scrn.blit(Restart_Level_Screen.text,(100,150))
        Restart_Level_Screen.restart_scrn.blit(self.image, self.btn_rect)
